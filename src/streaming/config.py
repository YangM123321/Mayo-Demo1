...
class KafkaConfig:
    ...
    def from_env() -> "KafkaConfig":
        bootstrap_servers = (
            os.getenv("KAFKA_BOOTSTRAP_SERVERS") or os.getenv("KAFKA_BROKER") or "localhost:19092"
        )
        ...
        return KafkaConfig(
            ...
            enable_idempotency_producer=os.getenv("KAFKA_IDEMPOTENT_PRODUCER", "1").strip().lower()
            in {"1", "true", "yes"},
